...
async def test_a(dut):
    ...
    dut.dda_fifo_tdata_in.value = 0b000000100_00001010_1_0001_0000000011111111 # hcount = 4, line_height = 10, wall type = 1, mapData = 1, WallX = almost full
    ...
    dut.dda_fifo_tvalid_in.value = 1
    # dut.dda_fifo_tdata_in.value = 0b11001000_10010110_1_0001_0000111100001111 # hcount = 200, line_height = 150, wall type = 1
    dut.dda_fifo_tdata_in.value = 0b000000101_00001001_1_0010_0000111100001111 # hcount = 5, line_height = 9, walltype = 1, mapData = 2
    dut.dda_fifo_tlast_in.value = 0
    ...
    dut.dda_fifo_tvalid_in.value = 1
    # dut.dda_fifo_tdata_in.value = 0b11001000_10010110_1_0001_0000111100001111 # hcount = 200, line_height = 150, wall type = 1
    dut.dda_fifo_tdata_in.value = 0b000000110_00001000_1_0011_0000111100001111 # hcount = 6, line_height = 8, wallType = 1, mapData = 3
    dut.dda_fifo_tlast_in.value = 0
...
def is_runner():
    ...
    sources = [proj_path / "hdl" / "transformation_tex.sv"]
